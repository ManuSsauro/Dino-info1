# Dino-info1[index.html](https://github.com/user-attachments/files/22005826/index.html)
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    <header class=" p-5">
        ...
        <nav class="container d-flex justify-content-between align-items-center">
            <img src="images__2_-removebg-preview.png" class="nav-img " loading="lazy">
            <ul class="nav mt-5">
        ...
        <section id="inicio" class="my-5">
            <div class="inicio-fundo d-flex justify-content-between align-items-center">
                <div class="esquerda-conteudo">
                    ...
                    <img src="i666280.jpeg" class="mb-3" width="563" height="278" loading="lazy">
                    <a href="#tropicalia" class="btn btn-primary btn-lg botao-inicio fw-semibold">Quero
                        conhecer!</a>
                </div>
                <img src="images__1_-removebg-preview.png"
                    alt="A imagem e de um triceratos, que significa rosto com tres chifres que  apeoca eram usados para duelos"
        ...
        <section id="tropicalia" class="my-5 pt-6 secao-tropicalia">
            <div class="container d-flex align-items-center ">
                <div class="col-4 d-flex justify-content-center">
                    <img src="i666280-removebg-preview.png" class="rounded-pill" alt="" width="273" height="331" loading="lazy">
                </div>
                <div class="col-5">
                    <h2>O que e paleontologia?</h2>
                    <p class="p-2">A paleontologia é a ciência que estuda a vida do passado geológico da Terra,
                         utilizando fósseis como evidências. Ela busca entender a história da vida, 
                         a evolução das espécies e os ambientes em que os organismos viviam, 
                         através da análise de vestígios preservados nas rochas. </p>
                </div>
            </div>
        </section>
    ...
    <footer class="text-center p-3 fst-italic">
        ...
        <p class="mt-3">Desenvolvido por manuella fraga teste</p>
    </footer>
